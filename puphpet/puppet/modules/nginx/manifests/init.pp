...
class nginx (
  ...
  validate_legacy(String, 'validate_string', $multi_accept)
  validate_legacy(String, 'validate_string', $package_name)
  validate_legacy(String, 'validate_string', $package_ensure)
  validate_legacy(String, 'validate_string', $package_source)
  validate_legacy(Array, 'validate_array', $proxy_set_header)
  validate_legacy(String, 'validate_string', $proxy_http_version)
  validate_legacy(Boolean, 'validate_bool', $confd_purge)
  validate_legacy(Boolean, 'validate_bool', $vhost_purge)
  if ($proxy_cache_path != false) {
    validate_legacy(String, 'validate_string', $proxy_cache_path)
  }
  if ($proxy_cache_levels !~ Integer) {
    fail('$proxy_cache_levels must be an integer.')
  }
  validate_legacy(String, 'validate_string', $proxy_cache_keys_zone)
  validate_legacy(String, 'validate_string', $proxy_cache_max_size)
  validate_legacy(String, 'validate_string', $proxy_cache_inactive)

  if ($fastcgi_cache_path != false) {
        validate_legacy(String, 'validate_string', $fastcgi_cache_path)
  }
  if ($fastcgi_cache_levels !~ Integer) {
    fail('$fastcgi_cache_levels must be an integer.')
  }
  validate_legacy(String, 'validate_string', $fastcgi_cache_keys_zone)
  validate_legacy(String, 'validate_string', $fastcgi_cache_max_size)
  validate_legacy(String, 'validate_string', $fastcgi_cache_inactive)
  if ($fastcgi_cache_key != false) {
    validate_legacy(String, 'validate_string', $fastcgi_cache_key)
  }
  if ($fastcgi_cache_use_stale != false) {
    validate_legacy(String, 'validate_string', $fastcgi_cache_use_stale)
  }

  validate_legacy(Boolean, 'validate_bool', $configtest_enable)
  validate_legacy(String, 'validate_string', $service_restart)
  validate_legacy(Boolean, 'validate_bool', $mail)
  validate_legacy(String, 'validate_string', $server_tokens)
  validate_legacy(String, 'validate_string', $client_max_body_size)
  ...
  validate_legacy(String, 'validate_string', $proxy_buffers)
  validate_legacy(String, 'validate_string', $proxy_buffer_size)
  ...
  validate_legacy(String, 'validate_string', $nginx_error_log)
  validate_legacy(String, 'validate_string', $http_access_log)
  validate_legacy(Hash, 'validate_hash', $nginx_upstreams)
  validate_legacy(Hash, 'validate_hash', $nginx_vhosts)
  validate_legacy(Hash, 'validate_hash', $nginx_locations)
  validate_legacy(Hash, 'validate_hash', $nginx_mailhosts)
  validate_legacy(Boolean, 'validate_bool', $manage_repo)
  validate_legacy(String, 'validate_string', $proxy_headers_hash_bucket_size)
  validate_legacy(Boolean, 'validate_bool', $super_user)
