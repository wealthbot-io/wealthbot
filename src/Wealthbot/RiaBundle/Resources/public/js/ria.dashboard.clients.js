...
$(function() {
    ...
    $('#ria_dashboard_client_menu ul.main-menu a').on('click', function(event) {
        var btn = $(this);
    ...
    $('#sas_cash_collection_form').on('submit', function(event) {
        var form = $(this);
    ...
    $('#client_view_btn').on('click', function(event) {
        var btn = $(this);
    ...
    $('.initial-rebalance-btn').on('click', function(event) {
        var btn = $(this);
        var accounts = [];
